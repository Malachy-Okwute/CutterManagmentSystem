...
{
    /// <summary>
    /// Data archive DTO representing parts produced along with data associated with it
    /// </summary>
    ...
    public record ProductionPartsLogDataArchiveDTO(bool IsArchived, string MachineNumber, string CutterNumber, string PartNumber, string SummaryNumber, string ToothCount, string PieceCount, string ToothSize, string UserFullName, string Comment, string FrequencyCheckResult, string CurrentShift, string? CutterChangeInfo, int? CMMDataId, CMMDataModel? CMMData)
    {
        /// <summary>
